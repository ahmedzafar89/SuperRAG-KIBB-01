...
class MetaGenerator {
  ...
  #defaultMeta() {
    return [
      {
        tag: "link",
        props: { type: "image/svg+xml", href: "/favicon.ico" },
        content: null,
      },
      {
        tag: "title",
        props: null,
        content: "SuperRAG | Enterprise AI Assistant",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://superrag.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      },
      {
        ...
        props: {
          property: "og:image",
          content:
            "https://raw.githubusercontent.com/NTT-DATA/superrag/master/images/promo.png",
        },
      },
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://superrag.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      { tag: "link", props: { rel: "apple-touch-icon", href: "/favicon.ico" } },
  ...
  #validUrl(faviconUrl = null) {
    if (faviconUrl === null) return "/favicon.ico";
    try {
      ...
      this.#customConfig = this.#defaultMeta().map((tag) => {
        ...
        if (tag.tag === "title") {
          return {
            ...
            content:
              customTitle ??
              "SuperRAG | Enterprise AI Assistant",
          };
        }
        // Override meta title
