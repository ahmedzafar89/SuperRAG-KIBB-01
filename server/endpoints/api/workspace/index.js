      ...
      content: {
        "application/json": {
          example: {
            ...
            deletes: ["custom-documents/superrag.txt-hash.json"]
          }
        }
      }
    }
           ...
           example: {
             ...
             attachments: [
               ...
               },
               {
                 ...
                 mime: "application/superrag-document",
       ...
       "application/json": {
         schema: {
           ...
           example: {
              ...
              sources: [{title: "superrag.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM,"}],
              close: true,
           ...
           example: [
            ...
            },
            {
            ...
            },
             {
              ...
              sources: [{title: "superrag.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM. This will only return in the final chunk."}],
              close: true,
              error: "null | text string of the failure mode."
            }
          ]
