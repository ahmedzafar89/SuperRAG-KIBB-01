...
https://github.com/NTT-DATA/superrag-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/superrag-chat-widget.min.js">
</script>
<!-- SuperRAG (https://superrag.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/NTT-DATA/superrag-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
