...
function FeatureVerification({ children }) {
  if (
    !window.localStorage.getItem("superrag_tos_experimental_feature_set")
  ) {
    function acceptTos(e) {
      e.preventDefault();

      window.localStorage.setItem(
        "superrag_tos_experimental_feature_set",
        "accepted"
      );
      showToast(
            ...
            <form onSubmit={acceptTos}>
              <div className="py-7 px-9 space-y-4 flex-col">
                <div className="w-full text-white text-md flex flex-col gap-y-4">
                  <p>
                    Experimental features of SuperRAG are features that we
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Potential bugs or issues using SuperRAG.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of SuperRAG.
                      </li>
                      <li>
                  ...
                  <p>
                    ...
                    <a
                      href="https://docs.superrag.com/beta-preview/overview"
