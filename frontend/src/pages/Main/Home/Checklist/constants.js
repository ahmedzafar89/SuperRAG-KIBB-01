...
export const CHECKLIST_UPDATED_EVENT = "superrag_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "superrag_checklist_completed";
export const CHECKLIST_HIDDEN = "superrag_checklist_dismissed";
