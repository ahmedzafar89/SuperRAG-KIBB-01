...
const System = {
  cacheKeys: {
    footerIcons: "superrag_footer_links",
    supportEmail: "superrag_support_email",
    customAppName: "superrag_custom_app_name",
    canViewChatHistory: "superrag_can_view_chat_history",
    deploymentVersion: "superrag_deployment_version",
  },
  ping: async function () {
