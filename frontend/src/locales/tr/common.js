...
const TRANSLATIONS = {
  ...
  api: {
    ...
    description:
      "API anahtarları, bu SuperRAG örneğine programatik olarak erişmeye ve yönetmeye olanak tanır.",
  ...
  llm: {
    title: "LLM Tercihi",
    description:
      "Bu, tercih ettiğiniz LLM sohbet ve gömme sağlayıcısının kimlik bilgileri ile ayarlarıdır. Bu anahtarların güncel ve doğru olması önemlidir; aksi takdirde SuperRAG doğru çalışmayacaktır.",
  ...
  transcription: {
    ...
    "warn-start":
      "Sınırlı RAM veya CPU'ya sahip makinelerde yerel Whisper modelini kullanmak, medya dosyalarını işlerken SuperRAG'nin duraksamasına neden olabilir.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Gömme, metni vektörlere dönüştürme sürecidir. Dosyalarınızın ve komutlarınızın işlenebilmesi için SuperRAG, bu kimlik bilgilerine ihtiyaç duyar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "SuperRAG örneğinizin nasıl çalışacağını belirleyen kimlik bilgileri ve ayarları burada bulunur. Bu anahtarların güncel ve doğru olması önemlidir.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Bağlantılı üçüncü taraf sağlayıcılarla ve SuperRAG ile verilerinizin nasıl ele alındığını burada yapılandırabilirsiniz.",
    llm: "LLM Seçimi",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "SuperRAG örneğinizi bir şifre ile koruyun. Bu şifreyi unutmanız hâlinde kurtarma yöntemi yoktur, bu yüzden mutlaka güvende saklayın.",
