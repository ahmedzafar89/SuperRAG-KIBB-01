...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "SuperRAG kan arbejde med mange LLM-udbydere. Dette vil være den tjeneste, der håndterer chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Velkommen til SuperRAG",
      description:
        "Hjælp os med at gøre SuperRAG tilpasset dine behov. Valgfrit.",
      email: "Hvad er din e-mail?",
      useCase: "Hvad vil du bruge SuperRAG til?",
      useCaseWork: "Til arbejde",
      useCasePersonal: "Til personligt brug",
      useCaseOther: "Andet",
      comment: "Hvordan hørte du om SuperRAG?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Opret dit første arbejdsområde og kom i gang med SuperRAG.",
    },
  },
  common: {
  ...
  api: {
    title: "API-nøgler",
    description:
      "API-nøgler giver indehaveren mulighed for programmatisk at få adgang til og administrere denne SuperRAG-instans.",
  ...
  llm: {
    title: "LLM-præference",
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for din foretrukne LLM chat- og indlejringsudbyder. Det er vigtigt, at disse nøgler er opdaterede og korrekte, ellers vil SuperRAG ikke fungere korrekt.",
  ...
  transcription: {
    ...
    "warn-start":
      "Brug af den lokale whisper-model på maskiner med begrænset RAM eller CPU kan få SuperRAG til at gå i stå under behandling af mediefiler.",
  ...
  embedding: {
    ...
    "desc-end":
      "Indlejring er processen med at omdanne tekst til vektorer. Disse legitimationsoplysninger er nødvendige for at omdanne dine filer og prompts til et format, som SuperRAG kan bruge til behandling.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for, hvordan din SuperRAG-instans vil fungere. Det er vigtigt, at disse nøgler er opdaterede og korrekte.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dette er din konfiguration for, hvordan tilsluttede tredjepartsudbydere og SuperRAG håndterer dine data.",
    llm: "Valg af LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Disse filer vil blive uploadet til dokumentbehandleren, der kører på denne SuperRAG-instans. Filene sendes ikke eller deles med en tredjepart.",
    },
    pinning: {
      what_pinning: "Hvad er dokumentfastlåsning?",
      pin_explained_block1:
        "Når du <b>fastlåser</b> et dokument i SuperRAG, vil vi indsætte hele dokumentets indhold i din prompt-vindue, så din LLM kan forstå det fuldt ud.",
      pin_explained_block2:
        "Dette fungerer bedst med <b>store kontekstmodeller</b> eller små filer, der er kritiske for dens vidensbase.",
      pin_explained_block3:
        "Hvis du ikke får de svar, du ønsker fra SuperRAG som standard, er fastlåsning en fremragende måde at få svar af højere kvalitet med et enkelt klik.",
      accept: "Okay, jeg har forstået",
    },
    watching: {
      what_watching: "Hvad gør det at overvåge et dokument?",
      watch_explained_block1:
        "Når du <b>overvåger</b> et dokument i SuperRAG, vil vi <i>automatisk</i> synkronisere dokumentets indhold fra dets oprindelige kilde med jævne mellemrum. Dette vil automatisk opdatere indholdet i alle arbejdsområder, hvor denne fil administreres.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Beskyt din SuperRAG-instans med en adgangskode. Hvis du glemmer den, findes der ingen genoprettelsesmetode, så sørg for at gemme denne adgangskode.",
