...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "SuperRAG peut fonctionner avec de nombreux fournisseurs LLM. Ce sera le service qui traitera vos discussions.",
    },
    userSetup: {
    ...
    data: {
      ...
      description:
        "Configurez comment SuperRAG stocke et traite vos données.",
      settingsHint:
    ...
    workspace: {
      ...
      description:
        "Créez votre premier espace de travail pour commencer à utiliser SuperRAG.",
    },
  },
  common: {
  ...
  general: {
    ...
    message: {
      ...
      body: "les avantages de SuperRAG",
    },
    pfp: {
  ...
  api: {
    title: "Clés API",
    description:
      "Les clés API permettent au titulaire d'accéder et de gérer de manière programmatique cette instance SuperRAG.",
  ...
  llm: {
    title: "Préférence LLM",
    description:
      "Voici les identifiants et les paramètres de votre fournisseur LLM de chat et d'intégration préféré. Il est important que ces clés soient actuelles et correctes, sinon SuperRAG ne fonctionnera pas correctement.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilisation du modèle local whisper sur des machines avec une RAM ou un CPU limités peut bloquer SuperRAG lors du traitement des fichiers multimédias.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'intégration est le processus de transformation du texte en vecteurs. Ces identifiants sont nécessaires pour transformer vos fichiers et invites en un format que SuperRAG peut utiliser pour traiter.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Voici les identifiants et les paramètres de fonctionnement de votre instance SuperRAG. Il est important que ces clés soient actuelles et correctes.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Voici votre configuration pour la gestion des données et des fournisseurs tiers connectés avec SuperRAG.",
    llm: "Sélection LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Ces fichiers seront téléchargés sur cette instance SuperRAG uniquement.",
    },
    pinning: {
      what_pinning: "Qu'est-ce que l'épinglage de documents ?",
      pin_explained_block1:
        "Lorsque vous épinglez un document, SuperRAG injectera le contenu intégral du document dans votre fenêtre de prompt comme contexte préalable pour chaque interaction.",
    ...
    watching: {
      ...
      watch_explained_block1:
        "Lorsque vous surveillez un document, SuperRAG re-synchronisera automatiquement le contenu du document depuis sa source de manière périodique.",
    ...
    checklist: {
      ...
      tasks: {
        ...
        visit_community: {
          ...
          description:
            "Rejoignez la communauté SuperRAG pour obtenir de l'aide et partager vos expériences.",
          action: "Visiter",
        },
      },
    },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Vous devez vous connecter à votre compte SuperRAG pour publier sur le Community Hub.",
          button: "Se connecter",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protégez votre instance SuperRAG avec un mot de passe. Si vous oubliez ce mot de passe, il n'y a pas de méthode de récupération, donc assurez-vous de le sauvegarder.",
