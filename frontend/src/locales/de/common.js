...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "SuperRAG ist mit vielen LLM-Anbietern kompatibel. Der ausgewählte Dienst wird für die Chats verwendet.",
    },
    userSetup: {
    ...
    survey: {
      title: "Willkommen bei SuperRAG",
      description:
        "Helfen Sie uns, SuperRAG an Ihre Bedürfnisse anzupassen. (Optional)",
      email: "Wie lautet Ihre E-Mail-Adresse?",
      useCase: "Wofür möchten Sie SuperRAG verwenden?",
      useCaseWork: "Beruflich",
      useCasePersonal: "Privat",
      useCaseOther: "Sonstiges",
      comment: "Wie haben Sie von SuperRAG erfahren?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Erstellen Sie Ihren ersten Workspace und starten Sie SuperRAG.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Sie sind auf dem Weg, ein SuperRAG-Experte zu werden!",
      dismiss: "schließen",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      heading: "Erkläre mir",
      body: "die Vorteile von SuperRAG",
    },
    pfp: {
  ...
  customization: {
    interface: {
      ...
      description: "Passen Sie die Benutzeroberfläche von SuperRAG an.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "Individualisieren Sie Ihre SuperRAG-Instanz durch eigenes Branding.",
    },
    chat: {
      title: "Chat",
      description: "Passen Sie Ihre Chat-Einstellungen für SuperRAG an.",
      auto_submit: {
    ...
    items: {
      ...
      "welcome-messages": {
        ...
        user: "Benutzer",
        message: "Nachricht",
        assistant: "SuperRAG Chat-Assistent",
  ...
  api: {
    title: "API-Schlüssel",
    description:
      "API-Schlüssel ermöglichen es dem Besitzer, programmatisch auf diese SuperRAG-Instanz zuzugreifen und sie zu verwalten.",
  ...
  llm: {
    title: "LLM-Präferenz",
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für Ihren bevorzugten LLM-Chat- und Einbettungsanbieter. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind, sonst wird SuperRAG nicht richtig funktionieren.",
  ...
  transcription: {
    ...
    "warn-start":
      "Die Verwendung des lokalen Whisper-Modells auf Maschinen mit begrenztem RAM oder CPU kann SuperRAG bei der Verarbeitung von Mediendateien zum Stillstand bringen.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Einbettung ist der Prozess, Text in Vektoren umzuwandeln. Diese Anmeldeinformationen sind erforderlich, um Ihre Dateien und Prompts in ein Format umzuwandeln, das SuperRAG zur Verarbeitung verwenden kann.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für die Funktionsweise Ihrer SuperRAG-Instanz. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dies ist Ihre Konfiguration dafür, wie verbundene Drittanbieter und SuperRAG Ihre Daten behandeln.",
    llm: "LLM-Auswahl",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Diese Dateien werden zum Dokumentenprozessor hochgeladen, der auf dieser SuperRAG-Instanz läuft. Diese Dateien werden nicht an Dritte gesendet oder geteilt.",
    },
    pinning: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Schützen Sie Ihre SuperRAG-Instanz mit einem Passwort. Wenn Sie dieses vergessen, gibt es keine Wiederherstellungsmethode, also stellen Sie sicher, dass Sie dieses Passwort speichern.",
