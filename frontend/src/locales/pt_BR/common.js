...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "SuperRAG funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao SuperRAG",
      description: "Ajude-nos a melhorar o SuperRAG. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o SuperRAG?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o SuperRAG?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o SuperRAG.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "Você está no caminho para se tornar um expert em SuperRAG!",
      dismiss: "fechar",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do SuperRAG",
    },
    pfp: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do SuperRAG com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o SuperRAG.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o SuperRAG lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do SuperRAG. Não são compartilhados com terceiros.",
    },
    pinning: {
