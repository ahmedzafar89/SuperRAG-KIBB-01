...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "SuperRAG יכול לעבוד עם ספקי מודלי שפה (LLM) רבים. זה יהיה השירות שיטפל בצ'אט.",
    },
    userSetup: {
      title: "הגדרת משתמש",
    ...
    survey: {
      title: "ברוכים הבאים ל-SuperRAG",
      description:
        "עזרו לנו לבנות את SuperRAG כך שיתאים לצרכים שלכם. אופציונלי.",
      email: "מה האימייל שלך?",
      useCase: "לאיזו מטרה תשתמש ב-SuperRAG?",
      useCaseWork: "לעבודה",
      useCasePersonal: "לשימוש אישי",
      useCaseOther: "אחר",
      comment: "איך שמעת על SuperRAG?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "צור את סביבת העבודה הראשונה שלך והתחל לעבוד עם SuperRAG.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "אתה בדרך להפוך למומחה SuperRAG!",
      dismiss: "סגור",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "הגדר את העדפות ממשק המשתמש שלך עבור SuperRAG.",
    },
    branding: {
      title: "מיתוג והתאמה אישית (Whitelabeling)",
      description: "התאם אישית את מופע ה-SuperRAG שלך עם מיתוג מותאם אישית.",
    },
    chat: {
      title: "צ'אט",
      description: "הגדר את העדפות הצ'אט שלך עבור SuperRAG.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "שפת תצוגה",
        description:
          "בחר את השפה המועדפת להצגת ממשק המשתמש של SuperRAG - כאשר תרגומים זמינים.",
      },
      logo: {
        title: "לוגו מותג",
      ...
      "welcome-messages": {
        ...
        user: "משתמש",
        message: "הודעה",
        assistant: "עוזר הצ'אט של SuperRAG",
  ...
  api: {
    title: "מפתחות API",
    description:
      "מפתחות API מאפשרים למחזיק בהם לגשת ולנהל באופן תכנותי את מופע SuperRAG זה.",
  ...
  llm: {
    title: "העדפות מודל שפה (LLM)",
    description:
      "אלה האישורים וההגדרות עבור ספק הצ'אט וההטמעה המועדף עליך. חשוב שמפתחות אלה יהיו עדכניים ונכונים, אחרת SuperRAG לא יפעל כראוי.",
    provider: "ספק LLM",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "ספק תמלול",
    "warn-start":
      "שימוש במודל ה-whisper המקומי על מכונות עם זיכרון RAM או מעבד מוגבלים עלול לגרום להאטה של SuperRAG בעת עיבוד קובצי מדיה.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "הטמעה היא תהליך של הפיכת טקסט לווקטורים. אישורים אלה נדרשים כדי להפוך את הקבצים וההנחיות שלך לפורמט ש-SuperRAG יכול להשתמש בו לעיבוד.",
    provider: {
      title: "ספק הטמעה",
    },
  },
  ...
  vector: {
    ...
    description:
      "אלה האישורים וההגדרות לאופן פעולת מופע ה-SuperRAG שלך. חשוב שמפתחות אלה יהיו עדכניים ונכונים.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "זוהי התצורה שלך לאופן שבו ספקים צד שלישי מחוברים ו-SuperRAG מטפלים בנתונים שלך.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "קבצים אלה יועלו למעבד המסמכים הפועל במופע זה של SuperRAG. קבצים אלה אינם נשלחים או משותפים עם צד שלישי.",
    },
    pinning: {
      what_pinning: "מהי הצמדת מסמכים?",
      pin_explained_block1:
        "כאשר אתה <b>מצמיד</b> מסמך ב-SuperRAG, אנו נזריק את כל תוכן המסמך לחלון ההנחיה שלך כדי שמודל השפה שלך יבין אותו במלואו.",
      pin_explained_block2:
        "זה עובד בצורה הטובה ביותר עם <b>מודלים בעלי הקשר רחב</b> או קבצים קטנים שהם קריטיים לבסיס הידע שלו.",
      pin_explained_block3:
        "אם אינך מקבל את התשובות הרצויות מ-SuperRAG כברירת מחדל, הצמדה היא דרך מצוינת לקבל תשובות איכותיות יותר בלחיצה אחת.",
      accept: "אוקיי, הבנתי",
    },
    watching: {
      what_watching: "מה עושה מעקב אחר מסמך?",
      watch_explained_block1:
        "כאשר אתה <b>עוקב</b> אחר מסמך ב-SuperRAG, אנו נסנכרן <i>אוטומטית</i> את תוכן המסמך שלך ממקורו המקורי במרווחי זמן קבועים. זה יעדכן אוטומטית את התוכן בכל סביבת עבודה שבה קובץ זה מנוהל.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "נדרש אימות",
          description:
            "עליך להתאמת עם מרכז הקהילה של SuperRAG לפני פרסום פריטים.",
  ...
  security: {
    ...
    password: {
      title: "הגנת סיסמה",
      description:
        "הגן על מופע ה-SuperRAG שלך באמצעות סיסמה. אם תשכח אותה, אין שיטת שחזור, אז ודא שאתה שומר סיסמה זו.",
