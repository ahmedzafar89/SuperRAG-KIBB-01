...
const TRANSLATIONS = {
  ...
  api: {
    title: "Chiavi API",
    description:
      "Le chiavi API consentono al titolare di accedere e gestire in modo programmatico questa istanza SuperRAG.",
  ...
  llm: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il tuo provider di chat e embedding LLM preferito. È importante che queste chiavi siano aggiornate e corrette, altrimenti SuperRAG non funzionerà correttamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilizzo del modello whisper locale su macchine con RAM o CPU limitate può bloccare SuperRAG durante l'elaborazione di file multimediali.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'embedding è il processo di trasformazione del testo in vettori. Queste credenziali sono necessarie per trasformare i file e i prompt in un formato che SuperRAG può utilizzare per l'elaborazione.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il funzionamento della tua istanza SuperRAG. È importante che queste chiavi siano aggiornate e corrette.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Questa è la tua configurazione per il modo in cui i provider terzi connessi e SuperRAG gestiscono i tuoi dati.",
    llm: "Selezione LLM",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Proteggi la tua istanza SuperRAG con una password. Se la dimentichi, non esiste un metodo di recupero, quindi assicurati di salvare questa password.",
