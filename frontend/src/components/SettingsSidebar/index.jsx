  ...
  return (
    <>
      <div>
        <Link
          to={paths.home()}
          className="flex shrink-0 max-w-[55%] items-center justify-start mx-[18px] my-[18px]"
        >
          <img
            src={logo}
            alt="Logo"
...
function HoldToReveal({ children, holdForMs = 3_000 }) {
  ...
  const [showing, setShowing] = useState(
    window.localStorage.getItem(
      "superrag_experimental_feature_preview_unlocked"
    )
  );
...
function AppVersion() {
  ...
  return (
    <Link
      to={`https://github.com/NTT-DATA/superrag/releases/tag/v${version}`}
      target="_blank"
      rel="noreferrer"
