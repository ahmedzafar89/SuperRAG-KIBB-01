...
const SHOW_METRICS_KEY = "superrag_show_chat_metrics";
const SHOW_METRICS_EVENT = "superrag_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `superrag_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `superrag_show_chat_metrics` key
 * @returns {void}
 */
