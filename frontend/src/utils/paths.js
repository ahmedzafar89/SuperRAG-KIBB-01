...
export default {
  ...
  github: () => {
    return "https://github.com/NTT-DATA/superrag";
  },
  discord: () => {
    return "https://discord.com/invite/6UyHPeGZAC";
  },
  docs: () => {
    return "https://docs.superrag.com";
  },
  chatModes: () => {
    return "https://docs.superrag.com/features/chat-modes";
  },
  mailToMintplex: () => {
    return "mailto:team@nttdata.com";
  },
  hosting: () => {
    return "https://my.nttdata.com/aio-checkout?product=superrag";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.superrag.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.superrag.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.superrag.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.superrag.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
