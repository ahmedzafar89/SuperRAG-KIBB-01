...
export const ONBOARDING_SURVEY_URL = "https://onboarding.superrag.com";

export const AUTH_USER = "superrag_user";
export const AUTH_TOKEN = "superrag_authToken";
export const AUTH_TIMESTAMP = "superrag_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "superrag_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "superrag_pinned_document_alert";
export const SEEN_WATCH_ALERT = "superrag_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "superrag_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "superrag_user_prompt_input_map";

export const APPEARANCE_SETTINGS = "superrag_appearance_settings";
