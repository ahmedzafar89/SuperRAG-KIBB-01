...
5. Use the file `cloudformation_create_superrag.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_superrag  Created 
 ⠿ Container superrag       Started  
```
