...
![SuperRAG](https://raw.githubusercontent.com/NTT-DATA/superrag/master/images/wordmark.png)

[SuperRAG](https://github.com/NTT-DATA/superrag)
...
```yaml
image:
  repository: mintplexlabs/superrag
  tag: "1.9.1"
...
```
helm install my-superrag ./superrag -f values-secret.yaml
```
...
| image.repository | string | `"mintplexlabs/superrag"` |  |
