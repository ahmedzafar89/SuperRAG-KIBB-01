...
<p align="center">
<b>SuperRAG:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
👉 Masaüstü için SuperRAG (Mac, Windows ve Linux)! <a href="https://superrag.com/download" target="_blank"> Şimdi İndir</a>
</p>
...
![Mesajlaşma](https://github.com/NTT-DATA/superrag/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/NTT-DATA/superrag-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_
...
- **`embed`**: [Web gömme widget’ı](https://github.com/NTT-DATA/superrag-embed) oluşturma ve entegrasyonu için alt modül.
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/NTT-DATA/superrag-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma

NTT DATA ve topluluk, SuperRAG'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında SuperRAG kurun →](../BARE_METAL.md)
...
_Bu uygulamalar NTT DATA tarafından yönetilmemektedir, ancak SuperRAG ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._

- [Midori AI Alt Sistem Yöneticisi](https://io.midori-ai.xyz/subsystem/superrag/) - Docker konteyner teknolojisini kullanarak yapay zeka sistemlerini verimli bir şekilde dağıtmanın pratik bir yolu.
- [Coolify](https://coolify.io/docs/services/superrag/) - Tek tıklamayla SuperRAG dağıtımı yapmanıza olanak tanır.
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - SuperRAG’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik

NTT DATA Inc. tarafından geliştirilen SuperRAG, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.

<details>
<summary><kbd>SuperRAG için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>

### Neden?

Bu bilgileri, SuperRAG’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3ANTT-DATA%2Fsuperrag%20.sendTelemetry\(&type=code)
...
Telif Hakkı © 2025 [NTT DATA][profile-link]. <br />
