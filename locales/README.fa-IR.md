...
<p align="center" dir="rtl">
    <b>SuperRAG:</b> اپلیکیشن همه‌کاره هوش مصنوعی که دنبالش بودید.<br />
...
<p align="center" dir="rtl">
👈 SuperRAG برای دسکتاپ (مک، ویندوز و لینوکس)! <a href="https://superrag.com/download" target="_blank">دانلود کنید</a>
</p>
...
SuperRAG یک اپلیکیشن کامل است که در آن می‌توانید از LLM‌های تجاری آماده یا LLM‌های متن‌باز محبوب و راه‌حل‌های vectorDB برای ساخت یک ChatGPT خصوصی بدون محدودیت استفاده کنید که می‌توانید آن را به صورت محلی اجرا کنید یا از راه دور میزبانی کنید و با هر سندی که به آن ارائه می‌دهید، هوشمندانه گفتگو کنید.

SuperRAG اسناد شما را به اشیایی به نام `workspaces` تقسیم می‌کند. یک Workspace مانند یک رشته عمل می‌کند، اما با اضافه شدن کانتینرسازی اسناد شما. Workspaceها می‌توانند اسناد را به اشتراک بگذارند، اما با یکدیگر ارتباط برقرار نمی‌کنند تا بتوانید زمینه هر workspace را تمیز نگه دارید.
</div>
<div dir="rtl">

## ویژگی‌های جذاب SuperRAG

- 🆕 [**عامل‌های هوش مصنوعی سفارشی**](https://docs.superrag.com/agent/custom/introduction)
...
- [SuperRAG Native Embedder](/server/storage/models/README.md) (پیش‌فرض)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [SuperRAG Built-in](https://github.com/NTT-DATA/superrag/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
- `embed`: زیرماژول برای تولید و ایجاد [ویجت قابل جاسازی وب](https://github.com/NTT-DATA/superrag-embed).
- `browser-extension`: زیرماژول برای [افزونه مرورگر کروم](https://github.com/NTT-DATA/superrag-extension).
...
NTT DATA و جامعه کاربران، روش‌ها، اسکریپت‌ها و قالب‌های متعددی را برای اجرای SuperRAG به صورت محلی نگهداری می‌کنند. برای مطالعه نحوه استقرار در محیط مورد نظر خود یا استقرار خودکار، به جدول زیر مراجعه کنید.
</div>
...
[یا راه‌اندازی نمونه تولیدی SuperRAG بدون Docker →](../BARE_METAL.md)
...
SuperRAG توسط NTT DATA Inc دارای ویژگی تله‌متری است که اطلاعات استفاده ناشناس را جمع‌آوری می‌کند.

<details>
<summary><kbd>اطلاعات بیشتر درباره تله‌متری و حریم خصوصی SuperRAG</kbd></summary>

### چرا؟

<div dir="rtl">
ما از این اطلاعات برای درک نحوه استفاده از SuperRAG، اولویت‌بندی کار روی ویژگی‌های جدید و رفع اشکالات، و بهبود عملکرد و پایداری SuperRAG استفاده می‌کنیم.
</div>
...
[مشاهده همه رویدادهای تله‌متری در کد منبع](https://github.com/search?q=repo%3ANTT-DATA%2Fsuperrag%20.sendTelemetry\(&type=code)
</div>
...
[![مشارکت‌کنندگان superrag](https://contrib.rocks/image?repo=ntt-data/superrag)](https://github.com/ntt-data/superrag/graphs/contributors)

[![نمودار تاریخچه ستاره‌ها](https://api.star-history.com/svg?repos=ntt-data/superrag&type=Timeline)](https://star-history.com/#ntt-data/superrag&Date)
